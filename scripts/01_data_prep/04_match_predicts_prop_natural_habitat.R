...
# directories
dataDir <- "0_data/"
predictsDir <- "4_PREDICTSMatchClimateIndex_noThresh/"
...
predicts_sp <- readRDS(paste0(predictsDir,"PREDICTSSitesWithClimateData_noThresh.rds"))
...
saveRDS(object = predicts_sp,file = paste0(outDir,"PREDICTSSitesWithClimateAndNatHab1.rds"))
