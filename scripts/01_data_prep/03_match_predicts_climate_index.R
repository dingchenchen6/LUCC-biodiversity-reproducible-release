...
##Read in average temperature data from CRU v4.09
tmp <- stack(paste0(dataDir,"cru_ts4.091901.2024.tmp.dat.nc"),varname = "tmp")

##Both cru data and predicts is in WGS84
wgs84 <- crs(tmp)

# read in the predicts sites - bird subset
